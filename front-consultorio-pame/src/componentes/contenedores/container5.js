      ...
      <div className="contact">
        <div className="location">
          ...
          <div className="info-txt">
            ...
            <h3>
              Dirección: Calle 1H #152 por 12 y 14-A <br />
              Residencial Col Mexico, 97125 Mérida, Yuc.
            </h3>
          </div>
        </div>
        <div className="appointment">
          ...
          <form className="contact-form">
            ...
            <div className="input-booktime">
              <label
                for="radio-time1"
                className="manual-time-btn manual-time-btn1"
              >
                <p>7:30</p>
              </label>
              <label
                for="radio-time2"
                className="manual-time-btn manual-time-btn2"
              >
                <p>8:00</p>
              </label>
              <label
                for="radio-time3"
                className="manual-time-btn manual-time-btn3"
              >
                <p>8:30</p>
              </label>
              <label
                for="radio-time4"
                className="manual-time-btn manual-time-btn4"
              >
                <p>9:00</p>
              </label>
              <label
                for="radio-time5"
                className="manual-time-btn manual-time-btn5"
              >
                <p>9:30</p>
              </label>
              <br />
